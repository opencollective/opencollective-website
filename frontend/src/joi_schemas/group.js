...
const schema = Joi.alternatives().try(
  Joi.object().keys({
    ...
    users1: Joi.object().keys({name: Joi.string(), email: Joi.string().email(), twitterHandle: Joi.string()}),
    users2: Joi.object().keys({name: Joi.string(), email: Joi.string().email(), twitterHandle: Joi.string()}),
    users3: Joi.object().keys({name: Joi.string(), email: Joi.string().email(), twitterHandle: Joi.string()}),
    users4: Joi.object().keys({name: Joi.string(), email: Joi.string().email(), twitterHandle: Joi.string()}),
    users5: Joi.object().keys({name: Joi.string(), email: Joi.string().email(), twitterHandle: Joi.string()}),
  })
);
