...
module.exports = {
  ...
  'Redirects to Github after clicking connect': (client) => {
    ...
    // const callbackUrl = encodeURIComponent(`${config.host.website}/auth/github/callback?slug=testcollective`);
    ...
    client
      ...
      .assert.urlContains('return_to=%2Flogin%2Foauth%2Fauthorize')
