...
export default (app) => {
  ...
  */
  ...
  app.get('/:slug/:verb(apply)/:type', mw.ga, mw.fetchGroupBySlug, controllers.hosts.apply, mw.addMeta, render);
  app.get('/:slug/:verb(apply)', mw.ga, mw.fetchGroupBySlug, controllers.hosts.apply, mw.addMeta, render);
  app.get('/:slug/settings', mw.ga, mw.addTitle('Settings'), mw.fetchGroupBySlug, render);
  ...
  app.get('/:slug([A-Za-z0-9-_]+)/expenses/:expenseid/:action(approve|reject)', mw.ga, mw.fetchGroupBySlug, mw.addMeta, render);
  app.get('/:slug([A-Za-z0-9-_]+)/donations/:action(request)', mw.ga, mw.fetchGroupBySlug, mw.addMeta, render);
